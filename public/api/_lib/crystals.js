...
const CRYSTAL_COSTS = {
  ...
  unlock_random_dar: 20,       // Открыть СЛУЧАЙНЫЙ дар (кнопка в Коллекции).
                               //   UI треба 20💎 (treasury.js:1179), сервер
                               //   тоже должен списывать 20. Без этого ключа
                               //   getCost() возвращал 0 и баланс не уменьшался
                               //   (тестер 29.05.2026: «не списываются 20»).
