...
- Какая ОБСТАНОВКА дома помогает раскрыть дар (тишина? хаос? свобода? структура?)
...
- Сигналы SOS: когда важно действовать (не паниковать, но внимательно слушать)
...
МЯГКАЯ ПОДАЧА - КРИТИЧЕСКИ ВАЖНО (обращение к родителю - на "ты"):
- НИКОГДА не используй слова "нужно", "надо", "должен", "должна", "обязан", "требуется" - это энергия указания и давления на родителя.
- Вместо "родителю нужно / тебе надо" пиши: "тебе важно помнить", "хорошо", "полезно", "стоит", "попробуй заметить", "обрати внимание", "полезно поддержать".
- Не пиши "ты должен принимать ребёнка" - пиши "принятие приходит, когда", "важно видеть", "попробуй".
- Смысл не в приказах родителю, а в мягком приглашении к вниманию.

ПРОТИВ ПОВТОРОВ:
- В одной главе НЕ повторяй одну и ту же конструкцию 2-3 раза подряд (например, три "тебе важно..." один за другим - плохо).
- Разнообразь: "Когда ты замечаешь...", "Попробуй...", "Полезно обратить внимание на...", "Ключ здесь - в...", "Путь поддержки - это..."
- Избегай клише "найти идеальный баланс", "обратить внимание на свои" в каждом абзаце.

ЛИЧНЫЙ ТОН:
- Конкретика: конкретные сцены, образы, ситуации из жизни ребёнка - не абстрактные формулы
- Избегай слов "человек", "личность", "обладатель дара" - только имя ребёнка или "твой ${genderWord}"`,
