...
ПРОТИВ ПОВТОРОВ:
- В одном разделе НЕ повторяй одну и ту же конструкцию 3 раза подряд (например, три раза "тебе важно..." один за другим — плохо).
- Разнообразь: "Восстановление приходит через...", "Попробуй...", "Полезно обратить внимание на...", "Ключ здесь — в...", "Путь обратно — это..."
- Избегай клише "найти идеальный баланс", "обратить внимание на свои" в каждом абзаце.
...
Верни JSON:
{
  ...
  "light_part": "8-10 предложений ОБЯЗАТЕЛЬНО на ТЫ (обращайся лично к читателю: 'в тебе', 'ты', 'твоя сила', 'тебя видят'). Цельный живой текст без заголовков и подразделов. Начни с конкретного образа: какая именно сила живёт в этом человеке (дай 1-2 яркие метафоры — не абстрактные формулы, а конкретную сцену из жизни). Потом — как эта сила проявляется в действиях (конкретные сферы: работа, отношения, творчество). Закончи — что именно получают люди рядом с тобой. Пиши так, будто говоришь с живым человеком, а не описываешь тип личности. Избегай слов 'человек', 'обладатель', 'носитель дара' — только 'ты'.${intPhrase ? ` В финале органично вплети: '${intPhrase}'` : ''}",
  "growth_points": {
  ...
  "transition_keys": "6-7 предложений. Три мягких приглашения к вниманию: что помогает восстановить внутренний ресурс, что возвращает ритм действий, что укрепляет связь с миром. ОБЯЗАТЕЛЬНО разнообразь формулировки — НЕ начинай каждое с 'тебе важно'. Используй: 'восстановление приходит через...', 'ритм возвращается, когда...', 'связь крепнет в моменты...', 'попробуй...', 'ключ здесь — в...'. Пиши как мудрый наставник, бережно и вдохновляюще, на 'ты'.",
  "ecology": {
