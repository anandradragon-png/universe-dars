  ...
  const MODES = {
    classic: {
      ...
      levels: {
        ...
        easy:   { cards: 3,  crystals: 0,  pointsWin: 0,  pointsTry: 0, streakBonus: false, mult: 1,   label: 'Песочница · 3',  opens: 1, targets: 1, sandbox: true },
        medium: { cards: 6,  crystals: 3,  pointsWin: 15, pointsTry: 1, streakBonus: true,  mult: 1.5, label: 'Средне · 6',   opens: 1, targets: 1 },
        hard:   { cards: 9,  crystals: 8,  pointsWin: 25, pointsTry: 3, streakBonus: true,  mult: 2,   label: 'Сложно · 9',   opens: 1, targets: 1 },
        expert: { cards: 12, crystals: 15, pointsWin: 40, pointsTry: 5, streakBonus: true,  mult: 3,   label: 'Эксперт · 12',  opens: 1, targets: 1 },
      }
    },
    multi: {
      name: 'Мультипоиск',
      ...
      icon: '&#127183;',
      levels: {
        hard:   { cards: 9,  crystals: 12, pointsWin: 50, pointsTry: 5, streakBonus: true, mult: 2.5, label: 'Сложно · 9',  opens: 4, targets: 3, hasBonus: true, hasTrap: true },
        expert: { cards: 12, crystals: 20, pointsWin: 80, pointsTry: 8, streakBonus: true, mult: 4,   label: 'Эксперт · 12', opens: 5, targets: 3, hasBonus: true, hasTrap: true },
      }
    }
  };
