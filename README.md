...
⚠️ ПЕРЕД ЛЮБЫМ ИЗМЕНЕНИЕМ КОДА прочитай **[RULES.md](RULES.md)** — обязательные законы разработки (границы задачи, запрет самодеятельности, ноль регрессий, контракт системы доступа, синхронизация двух разработчиков).
