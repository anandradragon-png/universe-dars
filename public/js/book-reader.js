...
const BookReader = (function() {
  ...
  // Последние страницы каждого дара — после прочтения дара показываем ЮпСоул
  // Это страницы перед началом следующего дара (или перед следующей главой)
  const YUPSOUL_PAGES = [
    19, 22, 25, 27, 29, 32, 34,       // ЛОГОС: после ЛА-ДА, И-СТОК, ЖАР, ТЕ-ЛО, СВЕ-ТО, ПРИ-ТОК, ЛЕ-ЛИ
    37, 39, 41, 43, 46, 49, 52,       // НИМА
    55, 58, 60, 62, 65, 68, 71,       // АНДРА
    74, 77, 80, 82, 86, 89, 92,       // ЗИНГРА
    101, 104, 107, 110, 113, 116, 120, // ЛУБА
    123, 126, 129, 132, 135, 138, 141, // ТУМА
    144, 147, 150, 153, 156, 159, 162, // АСТРА
    166, 169, 172, 174, 177, 180, 183, // БИТРА
    186, 189, 192, 195, 198, 202, 205, 208 // ОМА
  ];
