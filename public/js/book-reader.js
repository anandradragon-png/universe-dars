...
const BookReader = (function() {
  ...
  function renderChapter() {
    ...
    // Картинки даров и декоративные глифы из .docx убираем из глав книги.
    // PNG-глифы Даров живут только в карточках Даров (Сокровищница / Энциклопедия).
    // В книге — только текст. Решено по обратной связи автора 2026-05-21.
    let html = ch.html || '';
    html = html.replace(/<img\b[^>]*>/g, '');
    // Убираем пустые параграфы/заголовки, которые остались от удалённых картинок
