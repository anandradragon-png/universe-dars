...
5. ОБРАЩАЙСЯ ЛИЧНО к читателю на "ты" и к паре как "вы/ваша пара": "Ты и ${personName2} создаёте...", "В вашей паре...", "Тебе важно помнить...", "Твоя сила в том что...". ${personName2} упоминай по имени. НЕ пиши от третьего лица ("Светлана и Михаил создают..." - ЗАПРЕЩЕНО).
...
- Не пиши "ты должен принять" - пиши "принятие приходит через", "важно дать себе", "попробуй".
- Смысл не в приказах, а в мягком приглашении к вниманию и действию.

ПРОТИВ ПОВТОРОВ:
- В одном блоке (harmony/tension/advice/secret) НЕ повторяй одну и ту же конструкцию 2-3 раза подряд (например, три "тебе важно..." один за другим - плохо).
- Разнообразь формулировки: "Сила вашей пары - в...", "Попробуйте...", "Полезно обратить внимание на...", "Ключ здесь - в...", "Путь друг к другу - через..."
- Избегай клише "найти идеальный баланс", "обратить внимание на свои" в каждом блоке.

ЛИЧНЫЙ ТОН:
- Конкретика: конкретные сцены, образы, ситуации - не абстрактные формулы
- Избегай слов "человек", "партнёр", "обладатель" - заменяй на "ты" или имя

ФОРМАТ ОТВЕТА — строго JSON:
{
  "score": число от 60 до 98 (общая совместимость в %),
  "harmony": "3-4 предложения на 'ты/вы': ГДЕ вы с ${personName2} усиливаете друг друга",
  "tension": "2-3 предложения на 'ты/вы': возможные точки напряжения (без драмы, конструктивно)",
  "advice": "3-4 мягких приглашения на 'ты': что помогает вашей паре быть счастливее (без приказов - используй 'попробуй', 'полезно', 'важно помнить', 'ключ в том, чтобы')",
  "secret": "1-2 предложения — уникальная суперсила вашей пары, чего вы можете достичь ВМЕСТЕ"
}`;
