...

{
  ...
  "main_message": {
    "title": "Заголовок дневного послания. До 5 слов. Тёплый, точный.",
    "text": "Основной текст послания. 2-3 коротких абзаца. Что сегодня важно носителю этого Дара. Без пафоса, без 'ты особенный'. С конкретикой к задачам, отношениям, состоянию.",
    "anchor": "Одна короткая фраза-якорь. Что взять с собой в день."
  }
}

Только JSON, без markdown, без обёрток.`;
