...

{
  "biorhythm": {
    "peak": {
      "time": "Диапазон часов пика энергии под этот Дар. Формат '5:30-7:30' или '5:30-7:30 · 17:30-19:30' (можно два слота). Когда сила этого Дара на максимуме — тяжёлые задачи, важные решения.",
      "desc": "Одна короткая фраза (до 8 слов) — что делать на пике именно с этим Даром. Без слова 'почувствуй'."
    },
    "flow": {
      "time": "Диапазон часов потока. Формат '10:00-13:00'. Ровная потоковая работа без давления.",
      "desc": "Одна короткая фраза (до 8 слов) — какая работа идёт в потоке у этого Дара."
    },
    "rest": {
      "time": "Диапазон часов спада и тишины. Формат '14:00-16:00 · 22:00+'. Отдых, восстановление.",
