...
Сгенерируй JSON с тремя секциями:
1. «Биоритм» — три окна суток (пик / поток / тишина) с временем и краткой подписью под этот Дар
2. «Окна силы» — описание оптимальных временных слотов для этого Дара
3. «Ритуалы» — 3 коротких ритуала (утренний / дневной / вечерний) под характер этого Дара
...

{
  "biorhythm": {
    "peak": {
      "time": "ЧАСЫ пика энергии ИМЕННО под этот Дар. Формат 'Ч:ММ-Ч:ММ', можно два слота через ' · '. ВЫЧИСЛИ их из характера Дара: огненный/активный Дар силён утром, Дар-стратег днём, Дар глубины/интуиции вечером и ночью. У каждого Дара часы РАЗНЫЕ — не копируй чужие.",
      "desc": "Одна короткая фраза (до 8 слов) — что делать на пике именно с этим Даром. Без слова 'почувствуй'."
    },
    "flow": {
      "time": "ЧАСЫ ровного потока под этот Дар. Формат 'Ч:ММ-Ч:ММ'. Это другой интервал, чем пик. Подбери под суть Дара.",
      "desc": "Одна короткая фраза (до 8 слов) — какая работа идёт в потоке у этого Дара."
    },
    "rest": {
      "time": "ЧАСЫ спада и восстановления под этот Дар. Формат 'Ч:ММ-Ч:ММ', можно 'Ч:ММ+'. Интервал, когда сила этого Дара ниже всего.",
      "desc": "Одна короткая фраза (до 8 слов) — как восстанавливаться этому Дару, без давления на себя."
    }
  },
  "power_windows": {
  ...
  "rituals": {
    "dawn": {
      ...
      "time": "Часы утреннего ритуала. Формат 'Ч:ММ-Ч:ММ'. Согласуй с утренним окном этого Дара, не копируй чужие часы.",
      "steps": [
    ...
    "midday": {
      ...
      "time": "Часы дневного ритуала. Формат 'Ч:ММ-Ч:ММ'. Согласуй с дневным окном потока этого Дара.",
      "steps": [
        "Шаг 1.",
        "Шаг 2.",
        "Шаг 3."
    ...
    "evening": {
      ...
      "time": "Часы вечернего ритуала. Формат 'Ч:ММ-Ч:ММ'. Согласуй с вечерним окном этого Дара.",
      "steps": [
        "Шаг 1.",
        "Шаг 2.",
        "Шаг 3.",
